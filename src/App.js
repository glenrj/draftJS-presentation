    ...
    return (
      <React.Fragment>
        ...
        <main className="wrapper">
          ...
          <section id="3">
            <h3>How to add Draft.js to your project</h3>
          ...
          <section id="5">
            <h4>4. Almost there! The props on the editor component reference two functions that must be included, as well as the editorState, an object stored in the state of your app.</h4>
          ...
          <section id="7">
            ...
            <a href="https://codepen.io/Kiwka/pen/YNYvyG" className="image-link"><img src={require("./assets/richFunctions.png")} alt="screenshot of code, showing the functions that power Draft.js buttons" className="screenshot" /></a>
